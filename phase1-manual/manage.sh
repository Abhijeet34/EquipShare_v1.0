...
seed_database() {
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "   Student: student1@school.com / Student@123"
    else
...
show_help() {
    ...
    printf "                Adds default users and equipment\n"
    printf "    \n"
    ...
    printf "    Student: student1@school.com / Student@123\n"
    printf "\n"
...
show_menu() {
    while true; do
        ...
        case $choice in
            ...
            7) cleanup ;;
            8) show_help ;;
            9) echo ""; print_success "Goodbye!"; exit 0 ;;
            *) print_error "Invalid choice" ;;
        esac
